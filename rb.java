...
class Restaurant
{
    ...
    public void addUsers(User obj)
    {
        users.put(obj.userId,obj);
...
//                    char[] password=System.console().readPassword();
                    ...
                    if(obj.users.get(userId).password.equals(password))
                    {
                        while(condition)
                        {
                            printLine();

                            System.out.println("Welcome!!"+obj.users.get(userId).userName);
                            ...
                            switch (n)
                            {
                                ...
                                case 4:
                                    ...
                                    obj.users.get(userId).noOfOrders+=1;
                    ...
                    {
                        System.out.println("Wrong cresidentials");
                    }
                }
            ...
            else if(num==1)
            {
                ...
                System.out.println("Enter password:");
                String password=sc.nextLine();
                obj.addUsers(new User(userid,username,password));
            }
            else
            {
                flag=2;
